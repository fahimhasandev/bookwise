...
-- CreateIndex
CREATE UNIQUE INDEX "user_favorites_user_id_book_id_key" ON "user_favorites"("user_id", "book_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "user_reading_history_user_id_book_id_key" ON "user_reading_history"("user_id", "book_id");
